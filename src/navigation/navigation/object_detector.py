...
class ObjectDetector(Node):
    ...
    def path_callback(self, msg):
        ...
        wp2_x = msg.poses[3].pose.position.x
        wp2_y = msg.poses[3].pose.position.y
        wp3_x = msg.poses[4].pose.position.x
        wp3_y = msg.poses[4].pose.position.y

        base_x = (wp2_x + wp3_x) / 2.0
        base_y = (wp2_y + wp3_y) / 2.0

        self.target_x = base_x
        self.target_y = base_y -0.3
