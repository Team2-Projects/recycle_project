...
class Image_SaveNode(Node):
    def __init__(self):
        ...
        self.object_name = self.get_parameter('object').get_parameter_value().string_value

        # 2. 그 변수(object_name)를 사용하여 경로를 생성합니다.
        self.save_dir = Path("/home/hee/saved_images/{}/".format(self.object_name))
        ...
        existing_files = list(self.save_dir.glob("{}*.jpg".format(self.object_name)))
    ...
    def listener_callback(self, msg):
        ...
        if current_time - self.last_saved_time > self.save_interval:
            ...
            self.image_id += 1
            file_name = f"{self.object_name}_{self.image_id:06d}.jpg"
